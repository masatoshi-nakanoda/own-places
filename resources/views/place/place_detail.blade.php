...
<html lang="ja">
    ...
    <body>
        ...
        <div class="text-center">
            ...
            <div class="row">
                <div class="col-md-6"><img src="{{ $place->picture_path }}" class="d-block mx-auto" width="600"></div>
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div id="map" latd="-34.397" lngd="150.644" style="width:700px; height:220px"></div>
                    </div>
        ...
        <script>
                function initMap() {
                    var map;
                    var lat = document.getElementById( 'map' ).getAttribute( 'latd' );
                    var lng = document.getElementById( 'map' ).getAttribute( 'lngd' );
